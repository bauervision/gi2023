...
namespace CartoonFX
{
	public class CFXR_Demo : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Delete) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Backspace))
			{
				if (currentEffect != null)
				{
			...
			{
				var ray = demoCamera.GetComponent<Camera>().ScreenPointToRay(ControlFreak2.CF2Input.mousePosition);
