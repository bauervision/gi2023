...
public class CFX_Demo_New : MonoBehaviour
{
	...
	void Update()
	{
		...
		else if(ControlFreak2.CF2Input.GetKeyDown(KeyCode.Delete))
		{
			destroyParticles();
		}
		...
		if(ControlFreak2.CF2Input.GetMouseButtonDown(0))
		{
			...
			if(groundCollider.Raycast(Camera.main.ScreenPointToRay(ControlFreak2.CF2Input.mousePosition), out hit, 9999f))
			{
