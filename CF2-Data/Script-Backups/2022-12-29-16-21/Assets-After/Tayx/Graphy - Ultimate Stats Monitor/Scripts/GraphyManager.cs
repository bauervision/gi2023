...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        {
            return ControlFreak2.CF2Input.GetKeyDown(key1) && ControlFreak2.CF2Input.GetKey(key2)
                || ControlFreak2.CF2Input.GetKeyDown(key2) && ControlFreak2.CF2Input.GetKey(key1);
        }

        private bool CheckFor3KeyPress(KeyCode key1, KeyCode key2, KeyCode key3)
        {
            return ControlFreak2.CF2Input.GetKeyDown(key1) && ControlFreak2.CF2Input.GetKey(key2) && ControlFreak2.CF2Input.GetKey(key3)
                || ControlFreak2.CF2Input.GetKeyDown(key2) && ControlFreak2.CF2Input.GetKey(key1) && ControlFreak2.CF2Input.GetKey(key3)
                || ControlFreak2.CF2Input.GetKeyDown(key3) && ControlFreak2.CF2Input.GetKey(key1) && ControlFreak2.CF2Input.GetKey(key2);
        }
