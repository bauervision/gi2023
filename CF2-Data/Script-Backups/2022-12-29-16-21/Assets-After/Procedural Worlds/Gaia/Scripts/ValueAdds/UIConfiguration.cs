...
namespace Gaia
{
    ...
    public class UIConfiguration : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (ControlFreak2.CF2Input.GetKeyDown(m_uiToggleButton))
            {
            ...
            if (ControlFreak2.CF2Input.GetKeyDown(m_showPauseMenu))
            {
                if (m_pauseMenu != null)
                {
            ...
            if (m_usePhotoMode)
            {
                if (ControlFreak2.CF2Input.GetKeyDown(m_enablePhotoMode))
                {
