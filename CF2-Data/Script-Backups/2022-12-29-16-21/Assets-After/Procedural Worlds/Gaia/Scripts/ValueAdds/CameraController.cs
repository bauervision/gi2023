...
//        }
            ...
            if (mouseSideButton && ControlFreak2.CF2Input.GetAxis("Vertical") != 0)
            ...
            if (GUIUtility.hotControl == 0)
            {
                ...
                else if (ControlFreak2.CF2Input.GetAxis("Vertical") != 0 || ControlFreak2.CF2Input.GetAxis("Horizontal") != 0 || rotateBehind ||
                         mouseSideButton)
                {
                    RotateBehindTarget();
                }
            ...
            desiredDistance -= ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * Time.deltaTime * zoomRate *
