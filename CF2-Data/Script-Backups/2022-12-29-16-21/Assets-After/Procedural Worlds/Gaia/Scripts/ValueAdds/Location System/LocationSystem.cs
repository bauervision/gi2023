    ...
    public class LocationSystem : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (Application.isPlaying)
            {
                ...
                if (ControlFreak2.CF2Input.GetKey(m_locationProfile.m_mainKey) && ControlFreak2.CF2Input.GetKeyDown(m_locationProfile.m_prevBookmark))
                {
                    m_selectedBookmark--;
                ...
                if (ControlFreak2.CF2Input.GetKey(m_locationProfile.m_mainKey) && ControlFreak2.CF2Input.GetKeyDown(m_locationProfile.m_nextBookmark))
                {
                    m_selectedBookmark++;
                ...
                if (ControlFreak2.CF2Input.GetKey(m_locationProfile.m_mainKey) && ControlFreak2.CF2Input.GetKeyDown(m_locationProfile.m_addBookmarkKey))
                {
