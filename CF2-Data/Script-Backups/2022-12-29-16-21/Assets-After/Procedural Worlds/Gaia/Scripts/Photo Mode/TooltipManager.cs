...
namespace Gaia
{
    ...
    public class TooltipManager : MonoBehaviour
    {
        ...
        {
            ProcessTheme();
            Vector2 mousePos = ControlFreak2.CF2Input.mousePosition;
            ...
            if (ControlFreak2.CF2Input.GetMouseButton(0) || ControlFreak2.CF2Input.GetMouseButton(1) || ControlFreak2.CF2Input.anyKeyDown)
            {
                HideTooltip();
            }
        }
