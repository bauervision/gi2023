...
public class TTcamera3D : MonoBehaviour
{
    ...
    {  
        //TURN
        if (ControlFreak2.CF2Input.GetAxis("Mouse X") < 0)
        {
        ...
        //ZOOM
        if (ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") < 0 && zoom < 12f)
        {
            zoom = zoom + 0.25f;
        }
        if (ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") > 0 && zoom > 1f)
        {
            zoom = zoom - 0.25f;
        }
