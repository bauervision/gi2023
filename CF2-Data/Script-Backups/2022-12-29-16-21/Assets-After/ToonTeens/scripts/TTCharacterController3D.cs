...
public class TTCharacterController3D : MonoBehaviour
{
        ...
        if (alive)
        {
            ...
            if (active)
            {
                if (awake)
                {
                    ...
                    {
                        rigid.AddForce(trans.forward * ControlFreak2.CF2Input.GetAxisRaw("Vertical") * 0.0125f, ForceMode.VelocityChange);
                        rigid.AddTorque(Vector3.up * (ControlFreak2.CF2Input.GetAxisRaw("Horizontal") * 0.0125f), ForceMode.VelocityChange);
                    }
                }
                else
                {
    ...
    void Checkinput()
    {
        ...
        {
            if (ControlFreak2.CF2Input.GetKey(KeyCode.W)) forward = 1;
            else if (ControlFreak2.CF2Input.GetKey(KeyCode.S)) forward = -1;
            Checkwalls();
        ...
        {
            if (ControlFreak2.CF2Input.GetKey(KeyCode.D)) turn = 1;
            else if (ControlFreak2.CF2Input.GetKey(KeyCode.A)) turn = -1;
        }
        else turn = 0;

        //strafe
        if (ControlFreak2.CF2Input.GetKey(KeyCode.E) || ControlFreak2.CF2Input.GetKey(KeyCode.Q))
        {
            if (ControlFreak2.CF2Input.GetKey(KeyCode.E)) strafe = 1;
            else if (ControlFreak2.CF2Input.GetKey(KeyCode.Q)) strafe = -1;
            Checkwalls();
            if (blocked) forward = 0;
        }
        else strafe = 0;          
        ...
        //SITDOWN      
        if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.C) && forward == 0 )
        {
        ...
        //TEST HITS
        if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.U)) Hitwithforce (1,Random.Range(1f,5f));
        if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Y)) Hitwithforce( -1, Random.Range(1f, 5f));
    }
    void Checkground()
    {
        //ground
