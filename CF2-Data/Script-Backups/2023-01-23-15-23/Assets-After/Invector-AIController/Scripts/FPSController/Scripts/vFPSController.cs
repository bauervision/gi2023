...
public class vFPSController : vMonoBehaviour
{
    ...
    void MoveController()
    {
        inputX = ControlFreak2.CF2Input.GetAxis(horizontalInput);
        inputY = ControlFreak2.CF2Input.GetAxis(verticalInput);
        ...
        if (grounded)
        {
            ...
            speed = ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift) ? runSpeed : walkSpeed;
            crouch = ControlFreak2.CF2Input.GetKey(KeyCode.C);
    ...
    void AttackInput()
    {
        if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Mouse0)) onAttack.Invoke();
    }
    ...
    void RotationControl()
    {
        ...
        characterEuler.y += ControlFreak2.CF2Input.GetAxis(rotateCameraXInput) * cameraSensitivityX;
        transform.eulerAngles = characterEuler;
        cameraEuler.x -= ControlFreak2.CF2Input.GetAxis(rotateCameraYInput) * cameraSensitivityY;
