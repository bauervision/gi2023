...
public class SmoothCameraOrbit : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (ControlFreak2.CF2Input.GetMouseButton(2) && ControlFreak2.CF2Input.GetKey(KeyCode.LeftAlt) && ControlFreak2.CF2Input.GetKey(KeyCode.LeftControl))
        {
            desiredDistance -= ControlFreak2.CF2Input.GetAxis("Mouse Y") * 0.02f  * zoomRate*0.125f * Mathf.Abs(desiredDistance);
        }
        // If middle mouse and left alt are selected? ORBIT
        else if (ControlFreak2.CF2Input.GetMouseButton(0) )
        {
            xDeg += ControlFreak2.CF2Input.GetAxis("Mouse X") * xSpeed * 0.02f;
            yDeg -= ControlFreak2.CF2Input.GetAxis("Mouse Y") * ySpeed * 0.02f;
...
//        }
        ...
        desiredDistance -= ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * 0.02f  * zoomRate * Mathf.Abs(desiredDistance);
