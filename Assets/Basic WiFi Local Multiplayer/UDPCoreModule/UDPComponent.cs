  ...
  public bool serverRunning;
	...
	/*********************************************************************************************************/
		...
		public void Update()
		{
			...
			if (Application.internetReachability != NetworkReachability.ReachableViaLocalAreaNetwork) { // Check if there is a connection here
            
            // Here executes the desired action if there is a connection
			 noNetwork = true;
            ...
            if (Application.internetReachability == NetworkReachability.ReachableViaLocalAreaNetwork) { // Here it is checked if there is no connection
            
           
		      // Here performs the desired action if there is no connection
              noNetwork = false;
           }
