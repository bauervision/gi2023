...
namespace RayFire
{
    public static class RFRecorder
    {
        ...
        public static void CreateAnimationClip(RFCache[] cacheList, List<float> timeList, float threshold, int rate, string assetFolder, string clipName, bool optimizekeys)
        {
            // Stop
            if (timeList.Count == 0)
                return;
